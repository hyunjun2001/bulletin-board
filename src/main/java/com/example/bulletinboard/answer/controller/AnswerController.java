package com.example.bulletinboard.answer.controller;
...
import com.example.bulletinboard.user.service.UserService;
...
//        answerService.create(question, context);
...
//    }
    ...
    public String createAnswer(Model model, @PathVariable("id") Integer id,
                               @Validated AnswerForm answerForm, BindingResult bindingResult,
                               Principal principal) {
        Question question = questionService.getQuestion(id);
        ...
        Answer answer = answerService.create(question, answerForm.getContext(), siteUser);
    ...
    public String answerModify(AnswerForm answerForm,
        ...
        answerForm.setContext(answer.getContext());
        return "answer_form";
    }
    ...
    public String answerModify(@Validated AnswerForm answerForm, BindingResult bindingResult,
        ...
        answerService.modify(answer, answerForm.getContext());
        return String.format("redirect:/question/detail/%s#answer_%s", answer.getQuestion().getId(), answer.getId());
    }
    ...
    public String answerDelete(Principal principal, @PathVariable("id") Integer id) {
        Answer answer = answerService.getAnswer(id);
        if (!(answer.getAuthor().getUsername() == principal.getName())) {
